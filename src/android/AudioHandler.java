...
public class AudioHandler extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("startRecordingAudio")) {
            ...
            this.startPlayingAudio(args.getString(0), FileHelper.stripFileProtocol(fileUriStr), false);
        }
        else if (action.equals("startPlayingAudioLoop")) {
            String target = args.getString(1);
            String fileUriStr;
            try {
                Uri targetUri = resourceApi.remapUri(Uri.parse(target));
            ...
            this.startPlayingAudio(args.getString(0), FileHelper.stripFileProtocol(fileUriStr), true);
        }
